...
#' norm1_dipdist <- clusterabilitytest(normals1, "dip",
#'   distance_standardize = "NONE",
#'   reduction = "distance"
#' )
#' norm1_silvpca <- clusterabilitytest(normals1, "silverman", s_setseed = 123)
#' norm1_silvdist <- clusterabilitytest(normals1, "silverman",
#'   distance_standardize = "NONE",
...
#' norm2_silvdist <- clusterabilitytest(normals2, "silverman",
#'   reduction = "distance",
...
#' norm3_dipdist <- clusterabilitytest(normals3, "dip",
#'   reduction = "distance",
#'   distance_standardize = "NONE"
#' )
#' norm3_silvpca <- clusterabilitytest(normals3, "silverman", s_setseed = 123)
#' norm3_silvdist <- clusterabilitytest(normals3, "silverman",
#'   reduction = "distance",
#'   distance_standardize = "NONE", s_setseed = 123
#' )
#'
...
#' norm4_dipdist <- clusterabilitytest(normals4, "dip",
#'   reduction = "distance",
#'   distance_standardize = "NONE"
#' )
#' norm4_silvpca <- clusterabilitytest(normals4, "silverman", s_setseed = 123)
#' norm4_silvdist <- clusterabilitytest(normals4, "silverman",
#'   reduction = "distance",
#'   distance_standardize = "NONE", s_setseed = 123
#' )
#'
...
#' norm5_dipdist <- clusterabilitytest(normals5, "dip",
#'   reduction = "distance",
#'   distance_standardize = "NONE"
#' )
#' norm5_silvpca <- clusterabilitytest(normals5, "silverman", s_setseed = 123)
#' norm5_silvdist <- clusterabilitytest(normals5, "silverman",
#'   reduction = "distance",
#'   distance_standardize = "NONE", s_setseed = 123
#' )
#'
...
#' iris_dipdist <- clusterabilitytest(newiris, "dip",
#'   reduction = "distance",
#'   distance_standardize = "NONE"
#' )
#' iris_silvpca <- clusterabilitytest(newiris, "silverman", s_setseed = 123)
#' iris_silvdist <- clusterabilitytest(newiris, "silverman",
#'   reduction = "distance",
#'   distance_standardize = "NONE", s_setseed = 123
#' )
#'
...
#' cars_dipdist <- clusterabilitytest(cars, "dip",
#'   reduction = "distance",
#'   distance_standardize = "NONE"
#' )
#' cars_silvpca <- clusterabilitytest(cars, "silverman", s_setseed = 123)
#' cars_silvdist <- clusterabilitytest(cars, "silverman",
#'   reduction = "distance",
#'   distance_standardize = "NONE", s_setseed = 123
#' )
#'
